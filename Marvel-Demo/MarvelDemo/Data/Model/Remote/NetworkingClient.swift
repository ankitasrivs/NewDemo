...
final class NetworkingClient: NSObject {
    ...
    /// Method  will show result based api
    /// - Parameters:
    ///   - url: url
    ///   - queryParams: query parms
    ///   - method: url method
    /// - Returns: <#description#>
    func requestApi(url: String, queryParams: [String: Any], method: RequestType) -> Result<Response, ServiceError> {
