...
class CharacterListViewController: UITableViewController {
    ...
    private lazy var tableViewAdvancedDataSource: UITableViewDiffableDataSource<AdvancedSearchSection, AddAdvancedViewModel> = makeAdvancedDataSource()
...
private extension CharacterListViewController {
    ...
    func makeAdvancedDataSource() -> UITableViewDiffableDataSource<AdvancedSearchSection, AddAdvancedViewModel> {
        return UITableViewDiffableDataSource<AdvancedSearchSection, AddAdvancedViewModel>(tableView: tableView) {
            (tableView: UITableView, indexPath: IndexPath, item: AddAdvancedViewModel) -> UITableViewCell? in
